...
driver = webdriver.Chrome(
    "/Users/mahendra-mac/Documents/Python/AutomateProject/lib/chromedriver"
)
...
elem.clear()
elem.send_keys("Louisville, KY (SDF)", Keys.DOWN)
time.sleep(1)
elem1.clear()
elem1.send_keys("Las Vegas, NV (LAS)", Keys.DOWN)
